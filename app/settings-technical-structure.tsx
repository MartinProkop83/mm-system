...
const content = {
  cs: {
    ...
    confirmSection: (name: string) => `Archivovat sekci „${name}“? Pole v ní zůstanou uložená a vrátí se, když sekci obnovíš.`,
    confirmField: (name: string) => `Archivovat pole „${name}“? Hodnoty u motorů zůstanou uložené a vrátí se, když pole obnovíš.`,
  ...
  en: {
    ...
    confirmSection: (name: string) => `Archive section "${name}"? Its fields stay saved and come back if you restore the section.`,
    confirmField: (name: string) => `Archive field "${name}"? Engine values stay saved and come back if you restore the field.`,
